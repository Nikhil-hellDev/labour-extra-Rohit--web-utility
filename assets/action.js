...
const FIREBASEDB = `https://labourmanagement-8b62a.firebaseio.com/`;
const APIKEY = `AIzaSyBgkOPBcTa-rNxIgd7jMu_0pWH6-f1Nhd8`;
const REGISTER = `https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=`
